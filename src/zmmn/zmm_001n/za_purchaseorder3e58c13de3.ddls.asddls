/********** GENERATED on 11/18/2023 at 12:02:51 by CB9980000012**************/
 @OData.entitySet.name: 'A_PurchaseOrder' 
 @OData.entityType.name: 'A_PurchaseOrderType' 
 define root abstract entity ZA_PURCHASEORDER3E58C13DE3 { 
...
//On-condition is not relevant for runtime 
 _PurchaseOrderItem : association [0..*] to ZA_PURCHASEORDERITEMB740F222D9 on 1 = 1; 
 @OData.property.name: 'to_PurchaseOrderNote' 
//A dummy on-condition is required for associations in abstract entities 
//On-condition is not relevant for runtime 
 _PurchaseOrderNote : association [0..*] to ZA_PURCHASEORDERNOTEF615047A53 on 1 = 1; 
 } 
